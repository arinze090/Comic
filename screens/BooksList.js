...
import {getBooks, addBookmark, removeBookmark} from '../redux/action/action';
        ...
        <View style={{flexDirection: 'row', flex: 1}}>
          ...
          <View style={{flex: 1, marginLeft: 12}}>
            ...
            <View
              ...
              <Ionicons color="#64676D" name="book-outline" size={20} />
            ...
            <View style={{marginTop: 14}}>
              <TouchableOpacity
                ...
                style={{
                  flexDirection: 'row',
                  padding: 2,
                  backgroundColor: ifExists(item) ? '#F96D41' : '#350472',
                  borderRadius: 20,
                  alignItems: 'center',
